...
REM
REM Generated by Vivado on Sun Dec 28 19:30:59 +0530 2025
...
echo "xvlog --incr --relax -prj testbench_vending_machine_vlog.prj"
call xvlog  --incr --relax -prj testbench_vending_machine_vlog.prj -log xvlog.log
